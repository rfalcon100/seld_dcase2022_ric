""" Copied from:
https://github.com/asteroid-team/torch-audiomentations/blob/master/torch_audiomentations/augmentations/band_stop_filter.py

This fixes a problem with cuda tensors."""
from torch import Tensor
from typing import Optional

from .MyBandPassFilter import BandPassFilter
