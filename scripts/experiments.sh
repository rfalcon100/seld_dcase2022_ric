...
case $param in
    ...
    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model samplecnn --dataset_chunk_size_seconds 6 --model_features_transform none --mode train --input_shape 4 144000 \
    --wandb --exp_name "samplecnn_base" --seed $seed --job_id $job_id --task_id $job_sub_id
    ;;
    2)
    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model samplecnn --dataset_chunk_size_seconds 6 --model_features_transform none --mode train --input_shape 4 144000 --model_spatialmixup --model_augmentation --model_rotations \
    --wandb --exp_name "samplecnn+spm+aug+rot" --seed $seed --job_id $job_id --task_id $job_sub_id
    ;;
    3)
    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model samplecnn_gru --dataset_chunk_size_seconds 6 --model_features_transform none --mode train --input_shape 4 144000 \
    --wandb --exp_name "samplecnn-gru_base" --seed $seed --job_id $job_id --task_id $job_sub_id
    ;;
    4)
    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model samplecnn_gru --dataset_chunk_size_seconds 6 --model_features_transform none --mode train --input_shape 4 144000 --model_spatialmixup --model_augmentation --model_rotations \
    --wandb --exp_name "samplecnn-gru+spm+aug+rot" --seed $seed --job_id $job_id --task_id $job_sub_id
    ;;
esac
