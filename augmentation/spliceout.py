""" Copied from https://github.com/asteroid-team/torch-audiomentations/blob/master/torch_audiomentations/augmentations/spliceout.py"""
import torch
    ...
    def apply_transform(
        ...
        for i in range(samples.shape[0]):
            ...
            for j in range(self.num_time_intervals):
                ...
                fading_out, fading_in = sample[:, start: start + random_lengths[j] // 2], sample[:, start + random_lengths[j] // 2: start +
                                                                                                                                    random_lengths[
                                                                                                                                        j]]
