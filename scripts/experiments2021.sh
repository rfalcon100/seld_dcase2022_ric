...
case $param in
    ...
    2)
    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --model_augmentation --model_spatialmixup --model_rotations --model_rotations_noise --model_spec_augmentation --model_spatialmixup --use_mixup --curriculum_scheduler fixed\
    ...
    3)
    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --model_augmentation --model_spatialmixup --model_rotations --model_rotations_noise --model_spec_augmentation --model_spatialmixup --use_mixup --curriculum_scheduler linear\
    ...
    4)
    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --model_augmentation \
    --wandb --exp_name "crnn10-2.55_sony_mel_iv+aug" --seed $seed --job_id $job_id --task_id $job_sub_id  --dataset_backend sony
    ;;
    5)
    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
    ...
    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --model_augmentation --model_spatialmixup --model_rotations --model_rotations_noise --model_spec_augmentation --model_spatialmixup --use_mixup --curriculum_scheduler fixed\
    --wandb --exp_name "crnn10-2.55_sony_mel_iv+aug+spm+rot+rotnoise+specaug+mix__fixed" --seed $seed --job_id $job_id --task_id $job_sub_id  --dataset_backend sony
    ;;
    8)
    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --model_augmentation --model_spatialmixup --model_rotations --model_rotations_noise --model_spec_augmentation --model_spatialmixup --use_mixup --curriculum_scheduler linear\
...
#    4)
#    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
#    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --model_augmentation --model_spatialmixup --model_rotations --model_rotations_noise --model_spec_augmentation --model_spatialmixup --use_mixup --curriculum_scheduler loss\
...
#    7)
#    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
#    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --model_spatialmixup \
...
#    9)
#    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
#    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --model_rotations_noise \
#    --wandb --exp_name "crnn10-2.55_base_mel_iv+rotnoise" --seed $seed --job_id $job_id --task_id $job_sub_id  --dataset_backend baseline
#    ;;
#    10)
#    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
#    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --model_spec_augmentation\
#    --wandb --exp_name "crnn10-2.55_base_mel_iv+specaug" --seed $seed --job_id $job_id --task_id $job_sub_id  --dataset_backend baseline
#    ;;
#    11)
#    CUDA_VISIBLE_DEVICES=$cuda_device python main.py \
#    -c ./configs/run_train_dcase2021.yaml --exp_group $exp_group --model crnn10 --dataset_chunk_size_seconds 2.55 --model_features_transform mel_iv --mode train --use_mixup \
